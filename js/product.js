...
export function initProductPage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!product) {
            ...
            if (container)
                container.innerHTML = '<h2 style="padding: 100px; text-align: center;">Product not found.</h2>';
            return;
        }
    ...
    `;
        ...
        qtyMinus === null || qtyMinus === void 0 ? void 0 : qtyMinus.addEventListener('click', () => {
            let val = parseInt(qtyInput.value) || 1;
            if (val > 1)
                qtyInput.value = (val - 1).toString();
        });
        qtyPlus === null || qtyPlus === void 0 ? void 0 : qtyPlus.addEventListener('click', () => {
            let val = parseInt(qtyInput.value) || 1;
            qtyInput.value = (val + 1).toString();
        });
        ...
        reviewForm === null || reviewForm === void 0 ? void 0 : reviewForm.addEventListener('submit', (e) => {
            e.preventDefault();
            if (reviewSuccess) {
...
function renderRecommended(allProducts, currentId) {
